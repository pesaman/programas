class Employee
  ...
  #Metodo para esconder los primeros 6 numeros del num de cuenta
  def hide_account
    @deposit_account.gsub(/(\d{3})-(\d{3})-/, "*****")
  end
...
employee = Employee.new('Juan Perez', 'juan@gmail.com', 1_800, '123-456-6512')
